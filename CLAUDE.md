...
Scaffolding complete and verified (v0.1.0). Build, tests, lint, and typecheck pass. Next up: **Phase 1 / M1 — complete & verify the vanilla dataset**, then M2 blueprint parser. See `roadmap.md`.
